...
import com.java_Special_Class_Util.Util_DateTimeStamp;



public class RegisterTest_Dummy {
...
public WebDriver driver;
	...
	public void verifyingRegisterWithMandatoryFields() {
		...
		driver.findElement(By.xpath("//fieldset[@id = 'account']/descendant::input[@name = 'email']")).sendKeys(Util_DateTimeStamp.emailWith_DateTimeStamp())  ;  //("seleniumpanda@gmail.com");
